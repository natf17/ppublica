...
function showWeek(weekId, isEditMode) {
...
*/
	 ...
	 // iterate through week array of objects (days) to determine smallest startTime;
		...
		function drawPublisherAssignmentsEditMode() {
			// go through each day
			var timeSlotsInDay;
			var hours;
			var mins;
		...
		// draw assignments: either for viewing or for editing
		
		if(isEditMode) {
			drawPublisherAssignmentsEditMode();
		} else {
			console.log("NOT EDIT")
			drawPublisherAssignments();
		}

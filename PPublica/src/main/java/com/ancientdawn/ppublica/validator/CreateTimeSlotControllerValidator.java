...
@Component
public class CreateTimeSlotControllerValidator implements Validator {
	@Autowired
	private CreateTimeSlotValidator createValidator;
	...
	public void validate(Object target, Errors errors) {
		...
		createValidator.validate(timeSlot, errors);
